                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form  action="/api/addshelter" method="POST" enctype="multipart/form-data">
                                  @csrf
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Shelter</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="nameshelter" name="nameshelter" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <!-- back to home -->
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="shelter"
